...
[Divvi Protocol - KPI calculation functions](README.md) / celo-pg-s1
...
Defined in: [celo-pg-s1/index.ts:48](https://github.com/divvi-xyz/divvi-protocol/blob/main/scripts/calculateKpi/protocols/celo-pg-s1/index.ts#L48)
